            ...
            >
                ...
                {selectedId === 'colors' && (
                    <View style={styles.section}>
                        ...
                        <View style={{ gap: 12 }}>
                            <Text style={{ color: theme.colors.textPrimary, fontSize: 32, fontWeight: '900' }}>H1 — Primary 32px</Text>
                            <Text style={{ color: theme.colors.textPrimary, fontSize: 24, fontWeight: '700' }}>H2 — Primary 24px</Text>
                            <Text style={{ color: theme.colors.textSecondary, fontSize: 18, fontWeight: '600' }}>H3 — Secondary 18px</Text>
                            <Text style={{ color: theme.colors.textSecondary, fontSize: 16, fontWeight: '500' }}>Body — Secondary 16px</Text>
                            <Text style={{ color: theme.colors.textMuted, fontSize: 14, fontWeight: '400' }}>Caption — Muted 14px</Text>
                            <Text style={{ color: theme.colors.textMuted, fontSize: 11, fontWeight: '400' }}>Micro — Muted 11px</Text>
                        </View>
                    </View>
                )}
                ...
                {selectedId === 'settingscard' && (
                    <View style={styles.section}>
                        ...
                        <SettingsCard>
                            <Text style={{ color: theme.colors.textPrimary, fontWeight: '700', fontSize: 16, marginBottom: 4 }}>Default Card</Text>
                            <Text style={{ color: theme.colors.textMuted, fontSize: 13 }}>Glass-morphic container with standard border.</Text>
                        ...
                        <SettingsCard active>
                            <Text style={{ color: theme.colors.gold, fontWeight: '700', fontSize: 16, marginBottom: 4 }}>Active Card (Gold Border)</Text>
                            <Text style={{ color: theme.colors.textMuted, fontSize: 13 }}>Used when an important mode is enabled (e.g. Dev Mode).</Text>
                        </SettingsCard>
                    </View>
                )}
                ...
                {selectedId === 'actionsheet' && (
                    <View style={styles.section}>
                        ...
                        <Text style={{ color: theme.colors.textMuted, fontSize: 13, marginBottom: 20 }}>
                            The ActionSheet is a swipe-dismissable bottom sheet for option selection.
                            Tap below to open one with sample options.
                        </Text>
                        <AnimatedScaleButton
                            style={[commonStyles.dockedStartBtn, { paddingVertical: 16 }]}
